        ...
        <v-row>
          <v-col cols="5">
            <div style="position: relative" class="mt-16">
              ...
              <h1 class="text-grey">Welcome to my portfolio.</h1>
              <h1 class="text-white">I'M Laurindo Benjamim</h1>
              <span class="text-grey">Back-end Developer & Biomedical Engineer</span><br />
        ...
        <div>
          <v-row>
            ...
            <v-col cols="12" sm="6">
              ...
              <h4 class="">And Biomedical Engineer</h4>
              <p class="text-grey">
                I've been a back-end developer since 2015. 
                I have a degree in Biology, Technology in Systems 
                Analysis and Development, and I'm currently doing a 
              ...
              <br>
              <p class="text-grey">
                In recent years I have studied a little more about 
                AI using python and its integration with digital 
                electronics.
              </p>
              <br>
